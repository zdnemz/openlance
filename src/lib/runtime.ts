...
export const useRuntime = create<RuntimeState>((set) => ({
  ...
  tierSilverWei: "200000000000000000",
  tierGoldWei: "500000000000000000",
  ...
  load: async () => {
    try {
      ...
      set({
        ...
        tierSilverWei: (cfg as { tierSilverWei?: string }).tierSilverWei ?? "200000000000000000",
        tierGoldWei: (cfg as { tierGoldWei?: string }).tierGoldWei ?? "500000000000000000",
